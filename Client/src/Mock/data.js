...
const EXPERIMENT_DATA = [
      {
            id: '653901dee5d2fe5590dee8111',
            experimentsName: 'A&A Partners',
            ...
            experimentsGoal: [
                  ...
                  'Amélioration des différents outils',
            ],
            experimentDateStart: 'Avril 2024',
            experimentDateEnd: 'Avril 2025',
            experimentStack: [
                  'HTML',
                  'css',
                  'Bootstrap',
...
const COURSES_DATA = [
      {
            ...
            courses: 'Formation',
            coursesJobs: 'Développeur Web',
            coursesLvl: 'Bac+ 2',
            coursesDateStart: 'Avril 2024',
            coursesDateEnd: 'Avril 2025',
            coursesDescription: [
                  "La formation au sein d'OpenClassrooms, s'est réalisée 100% à distance, en alternance avec l'entreprise A&A Partners. Suivie par un mentor toutes les semaines pour suivre l'avancement des projets et revenir sur différents problèmes rencontrés.",
                  "J'ai réalisé mon alternance chez A&A Partners. Durant cette alternance, j'ai pu décrouvrir un environement de developpement autour de Java, en participant aux évolutions des produits, mais aussi à la création des sites pour les clients, les refontes des anciens sites.",
            ],
            coursesGoal: [
